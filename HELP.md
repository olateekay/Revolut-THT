...
* The following dependency is not known to work with Spring Native: 'Spring REST Docs'. As a result, your application may not work as expected.
...
```
$ docker run --rm hello:0.0.1-SNAPSHOT
```
